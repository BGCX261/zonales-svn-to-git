<?php
/**
 * @version	$Id: admin.eqzonales.php 856 2010-06-09 22:08:24Z franpaez $
 * @package	Zonales
...
require_once (JPATH_COMPONENT_SITE.DS.'controllers'.DS.'eq.php');
require_once (JPATH_COMPONENT_SITE.DS.'controllers'.DS.'band.php');
